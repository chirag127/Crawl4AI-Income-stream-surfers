---
url: https://developer.chrome.com/blog/new-in-devtools-136?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-136?hl=en
date: 2025-05-11T16:58:38.156917
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#main-content)
  * [Español – América Latina](https://developer.chrome.com/blog/new-in-devtools-136?hl=es-419)




  * On this page
  * [Performance panel improvements](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#perf)
    * [New performance insights](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#perf-insights)
    * [Click to highlight](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#click-to-highlight)
    * [Server timings in Summary of network requests](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#server-timings)
  * [Filter cookies in 'Privacy and security'](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#cookies-filter)
  * [Sizes in kB units in tables across panels](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#kb-units)
  * [Autocomplete supports corner-shape and corner-*-shape in Elements > Styles](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#corner-shape-autocomplete)
  * [Experimental: Highlighting issues with elements and attributes in DOM](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#issues-in-dom)
  * [Lighthouse 12.5.0](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#lighthouse)
  * [Miscellaneous highlights](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#misc)
  * [Download the preview channels](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#preview-channels)
  * [Get in touch with the Chrome DevTools team](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#contact-us)
  * [What's new in DevTools](https://developer.chrome.com/blog/new-in-devtools-136?hl=en#whats-new)
...
The **Performance** panel takes the data from the [`Server-Timing` response header](https://developer.mozilla.org/docs/Web/HTTP/Reference/Headers/Server-Timing#syntax) header.
...
Chromium issue: [402346406](https://crbug.com/402346406).
...
Chromium issue: [378738916](https://crbug.com/378738916).
## Lighthouse 12.5.0
The **Lighthouse** panel now runs Lighthouse 12.5.0.
Most notably in this version, `legacy-javascript` now uses [Baseline](https://web.dev/baseline) instead of `esmodules`. See the [full list of changes](https://github.com/GoogleChrome/lighthouse/releases/tag/v12.5.0).
...
These are some noteworthy fixes and improvements in this release:
  * **Performance** > **Insights** > **Network dependency tree** : Now shows time for all network requests in the network tree ([400708304](https://crbug.com/400708304)). 
    * **Network dependency tree** : Now shows time for all network requests in the network tree ([400708304](https://crbug.com/400708304)).
  * **Animations** : Fixed a bug that caused detached elements to appear in the **Memory** panel because of captured animations [400635410](https://crbug.com/400635410).
  ...
  * **Memory** : Heap snapshot initialization has been boosted by parallelizing tasks between two workers instead of using one ([42203857](https://crbug.com/42203857)).
  * **Issues** : Now reports Local Network Access (LNA) CORS errors ([395895368](https://crbug.com/395895368)).
  * **Accessibility** : 
    * **Tooltips** : Now appear on hotkey press instead of focus ([396311936](https://crbug.com/396311936)).
    * **Elements** > **Styles** : The `var()` function can now be interacted with keyboard, meaning you can select `--custom-property` and press `Enter` to go to its link target ([401212692](https://crbug.com/401212692)).
