---
url: https://developer.chrome.com/blog/new-in-devtools-134?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-134?hl=en
date: 2025-05-11T16:58:29.879580
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#main-content)
  * [Español – América Latina](https://developer.chrome.com/blog/new-in-devtools-134?hl=es-419)




  * On this page
  * [Privacy and security panel](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#privacy-and-security)
  * [Performance panel improvements](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#perf)
    * [Calibrated CPU throttling presets](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#calibrated-cpu-throttling)
    * [Select different performance events in the same AI chat](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#perf-select)
    * [First- and third-party highlighting in Performance](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#perf-third-party)
    * [Field data in marker tooltips and insights](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#field-data)
    * ['Forced reflow' insight](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#forced-reflow)
    * ['Optimize DOM size' insight](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#dom-size)
    * [Extend the performance trace with console.timeStamp](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#console-timestamp)
  * [Elements panel improvements](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#elements)
    * [Real-time values of animated styles](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#real-time-animation)
    * [Support for :open pseudo-class and various pseudo-elements](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#pseudo)
  * [Copy all console messages](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#copy-console)
  * [Byte units in the Memory panel](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#byte-units)
  * [Miscellaneous highlights](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#misc)
  * [Download the preview channels](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#preview-channels)
  * [Get in touch with the Chrome DevTools team](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#contact-us)
  * [What's new in DevTools](https://developer.chrome.com/blog/new-in-devtools-134?hl=en#whats-new)
...
Chromium issue: [352364594](https://crbug.com/352364594).
...
Additionally, click account_tree icon next to a highlighted entry in the table to go to the **Bottom-up** tab grouped by third parties.
### Field data in marker tooltips and insights
If you have [field data turned on](https://developer.chrome.com/docs/devtools/performance/overview#compare), you can now see it in metric marker tooltips and the **Insights** tab.
Chromium issue: [368135130](https://crbug.com/368135130).
### 'Forced reflow' insight
The **Performance** > **Insights** tab gets a new addition to the set of insights: **Forced reflow**. [Forced reflow](https://web.dev/articles/avoid-large-complex-layouts-and-layout-thrashing?utm_source=devtools#avoid_layout_wherever_possible) happens when the rendering engine pauses script execution to calculate style and layout. Forced reflows can be bottlenecks you may want to avoid.
...
Chromium issue: [369766156](https://crbug.com/369766156).
...
The [Extensibility API](https://developer.chrome.com/docs/devtools/performance/extension) now supports`console.timeStamp`. In addition to `performance.measure` and `performance.mark`, you can now create custom tracks in the performance trace and capture custom marks using `console.timeStamp`, as lighter alternative that doesn't add entries to the browser's internal [performance timeline](https://developer.mozilla.org/docs/Web/API/Performance_API) but only shows them in the performance trace.
...
With **Capture settings** > check_box **Show custom tracks** , you will see your custom track in the trace:
...
The **Elements** panel now supports the [`:open` pseudo-class](https://drafts.csswg.org/selectors-4/#open-state) in the **Styles** > **:hov** > **Force specific element state** section for certain HTML elements such as `<details>`, `<select>`, `<dialog>`, and `<input>`.
Additionally, the **Elements** panel now also supports several new pseudo-elements: `::checkmark`, `::picker-icon`, and [carousel-related](https://drafts.csswg.org/css-overflow-5/#scroll-markers) `::column`, `::scroll-button`, `::scroll-marker`, and `::scroll-marker-group`.
Chromium issues: [383157184](https://crbug.com/383157184), [379805728](https://crbug.com/379805728).
...
Chromium issues: [40206460](https://crbug.com/40206460), [384967020](https://crbug.com/384967020).
...
Chromium issue: [388589515](https://crbug.com/388589515).
## Miscellaneous highlights
These are some noteworthy fixes and improvements in this release:
  * **Performance** : 
    * **Annotations** : You can now click your label to select the corresponding entry ([crbug.com/388224764](https://crbug.com/388224764)).
    * **Insights** : Clicking CLS in the **Insights** tab now selects the worst cluster instead of the worst shift.
  * **Ignore list** : Node internals starting with `node:` are now ignored by default ([crbug.com/382453615](https://crbug.com/382453615)).
  * **Live expressions** : Fixed bug that caused live expression to affect the `$_` command ([crbug.com/388437265](https://crbug.com/388437265)).
  * **Elements** > **Styles** : Relative lengths now have a popover that shows the absolute value ([crbug.com/40778486](https://crbug.com/40778486)).
