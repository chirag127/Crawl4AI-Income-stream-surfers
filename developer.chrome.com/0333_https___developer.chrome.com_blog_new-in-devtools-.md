---
url: https://developer.chrome.com/blog/new-in-devtools-122?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-122?hl=en
date: 2025-05-11T16:57:55.778602
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#main-content)
  * [Español – América Latina](https://developer.chrome.com/blog/new-in-devtools-122?hl=es-419)




  * On this page
  * [The official collection of Recorder extensions is live](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#recorder-extensions)
  * [Network improvements](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#network)
    * [Failure reason in the Status column](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#failure-status)
    * [Improved Copy submenu](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#copy-submenu)
  * [Performance improvements](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#perf-improvements)
    * [Breadcrumbs in the Timeline](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#perf-breadcrumbs)
    * [Event initiators in the Main track](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#event-initiators)
    * [JavaScript VM instance selector menu for Node.js DevTools](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#js-vm-menu)
  * [Elements improvements](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#elements-improvements)
    * [The ::view-transition pseudo-element is now editable in Styles](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#view-transition)
    * [The align-content property support for block containers](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#align-content-in-blocks)
  * [New shortcut and command in Sources](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#sources)
  * [Posture support for emulated foldable devices](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#device-posture)
  * [Third-party cookies phaseout warnings in the Network and Application panels](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#3pc)
  * [Lighthouse 11.4.0](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#lighthouse)
  * [Miscellaneous highlights](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#misc)
  * [Download the preview channels](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#preview-channels)
  * [Get in touch with the Chrome DevTools team](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#contact-us)
  * [What's new in DevTools](https://developer.chrome.com/blog/new-in-devtools-122?hl=en#whats-new)
...
The official collection of export and replay [**Recorder** extensions](https://chromewebstore.google.com/collection/customize_recorder) is now live.
...
Chromium issues: [1506760](https://crbug.com/1506760).
...
Chromium issues: [1267033](https://crbug.com/1267033), [1276452](https://crbug.com/1276452), [798498](https://crbug.com/798498).
...
Chromium issues: [1467739](https://crbug.com/1467739).
...
Chromium issues: [1434596](https://crbug.com/1434596).
### JavaScript VM instance selector menu for Node.js DevTools
In the **Performance** panel of Node.js DevTools, you can now select a JavaScript VM instance from the corresponding drop-down menu in the action bar. A similar feature was available in the [soon-to-be-deprecated **JavaScript Profiler**](https://developer.chrome.com/blog/new-in-devtools-114#js-profiler).
Chromium issues: [1511813](https://crbug.com/1511813).
...
Chromium issues: [1511233](https://crbug.com/1511233).
### The `align-content` property support for block containers
The `align-content` property now works with any [block containers](https://drafts.csswg.org/css-align/#distribution-block), including `table-caption` and `table-cell`. Previously, it worked only with grid and flex.
Chromium issues: [1500511](https://crbug.com/1500511).
...
Chromium issues: [1486933](https://crbug.com/1486933), [1467464](https://crbug.com/1467464).
## Posture support for emulated foldable devices
[**Device mode**](https://developer.chrome.com/docs/devtools/device-mode) now lets you set [posture](https://www.w3.org/TR/device-posture/#posture-types) of an emulated foldable device: **Continuous** or **Folded**. The continuous posture refers to a "flat" position and folded forms an angle between sections of the display.
Additionally, the [**Devices**](https://developer.chrome.com/docs/devtools/settings/devices) list gets a new emulated foldable device: Asus Zenbook Fold.
Chromium issue: [1066842](https://crbug.com/1066842).
## Dynamic theming
...
Chromium issues: [1483276](https://crbug.com/1483276).
## Third-party cookies phaseout warnings in the Network and Application panels
Both the **Network** and **Application** panels now highlight and show warnings next to cookies affected by the third-party restrictions from [Tracking Protection](https://blog.google/products/chrome/privacy-sandbox-tracking-protection/).
...
Chromium issues: [1506225](https://crbug.com/1506225), [1503961](https://crbug.com/1503961).
## Lighthouse 11.4.0
The **Lighthouse** panel now runs Lighthouse 11.4.0. See the [full list of changes](https://github.com/GoogleChrome/lighthouse/releases/tag/v11.4.0). Among notable changes is the new audit that lets you detect if your website still uses third-party cookies.
...
Chromium issues: [1504938](https://crbug.com/1504938), [1499868](https://crbug.com/1499868), [1512161](https://crbug.com/1512161), [1515224](https://crbug.com/1515224), [1515418](https://crbug.com/1515418), [1516998](https://crbug.com/1516998), [1517015](https://crbug.com/1517015).
## Miscellaneous highlights
These are some noteworthy fixes and improvements in this release:
  * **Animations** : 
    * Fixed the bug with screenshot popover rendering out of bounds ([1506991](https://crbug.com/1506991)).
    * Fixed the bug with removed animation nodes not marked as removed ([1506561](https://crbug.com/1506561)).
  * **Network** : 
    * **Header overrides** : Fixed a bug with a false purple dot icon in **Headers** tab ([1507856](https://crbug.com/1507856)).
    * **Preview** : Fixed a bug with an unnecessary double decoding ([1509336](https://crbug.com/1509336)).
    * Fixed a bug due to which short requests didn't show up ([1509862](https://crbug.com/1509862)).
  * **Application** > **IndexedDB** : Rearranged buttons in the action bar for consistency with other panels ([1393800](https://crbug.com/1393800)).
  * **Sensors** : Fixed a bug with unavailable location incorrect successful callback ([1486859](https://crbug.com/1486859)).
  * **Performance** : 
    * The **Collect garbage** button now has an appropriate icon, "mop" instead of a "bin" ([1507530](https://crbug.com/1507530)).
    * Performance trace now retains data when navigating to `about:blank` ([1509947](https://crbug.com/1509947)).
