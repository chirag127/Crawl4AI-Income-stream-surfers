---
url: https://developer.chrome.com/blog/new-in-devtools-121?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-121?hl=en
date: 2025-05-11T16:57:49.129306
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-121?hl=en#main-content)
  * English
  * Deutsch
...
The corresponding experiment was turned on by default in this version but will be reverted. You can track the progress in [crbug.com/1523150](https://crbug.com/1523150).
...
Feel free to leave your feedback about the feature in [crbug.com/1500573](https://crbug.com/1500573).
Chromium issue: [1486431](https://crbug.com/1486431).
## Elements improvements
### `@font-palette-values` support
The Elements panel now supports the [@font-palette-values](https://developer.mozilla.org/docs/Web/CSS/@font-palette-values) CSS at-rule. It lets you customize the default values of the [font-palette](https://developer.mozilla.org/docs/Web/CSS/font-palette) property.
...
Chromium issue: [1501781](https://crbug.com/1501781).
### Supported case: Custom property as a fallback of another custom property
**Elements** > **Styles** now resolves a custom property that is a [fallback of another custom property](https://developer.mozilla.org/docs/Web/CSS/var#using_a_custom_property_as_a_fallback).
Chromium issue: [1499265](https://crbug.com/1499265).
...
DevTools uses [source maps](https://developer.chrome.com/docs/devtools/javascript/source-maps) to let you debug your original code in **Sources** and **Scope** even after you've combined, minified, or compiled it. This experiment lets you evaluate your original variable names consistently across DevTools, including but not limited to:
  * Expressions in the **Console** and autocomplete suggestions
  * [Live expressions](https://developer.chrome.com/docs/devtools/console/live-expressions)
  * [Watch expressions](https://developer.chrome.com/docs/devtools/javascript/reference#watch)
  * [Conditional breakpoints](https://developer.chrome.com/docs/devtools/javascript/breakpoints#conditional-loc) and [logpoints](https://developer.chrome.com/devtools/javascript/breakpoints#log-loc)


For more details, see the [corresponding RFC](https://github.com/ChromeDevTools/rfcs/discussions/9).
Chromium issue: [1444349](https://crbug.com/1444349).
...
Chromium issue: [1495751](https://crbug.com/1495751).
...
Chromium issue: [1496355](https://crbug.com/1496355).
...
Chromium issue: [1479986](https://crbug.com/1479986).
...
Chromium issue: [1469776](https://crbug.com/1469776).
## New Command Menu options for adding and removing request blocking patterns
You can now type commands to add or remove network request blocking patterns into the [Command Menu](https://developer.chrome.com/docs/devtools/command-menu).
...
The experimental **CSP violations** tab introduced in [version 89](https://developer.chrome.com/blog/new-in-devtools-89#csp) has been removed as redundant.
To see CSP details at a glance, navigate to [**Application** > **Frames**](https://developer.chrome.com/docs/devtools/application/frames) > **Content Security Policy (CSP)**.
Additionally, the [**Issues** panel](https://developer.chrome.com/docs/devtools/issues) reports CSP violations.
## Lighthouse 11.3.0
The **Lighthouse** panel now runs Lighthouse 11.3.0. See the [full list of changes](https://github.com/GoogleChrome/lighthouse/releases/tag/v11.3.0). Among notable changes is the ability to run reports on 404 pages.
...
Chromium issues: [1338391](https://crbug.com/1338391), [1500662](https://crbug.com/1500662), [1420362](https://crbug.com/1420362).
## Miscellaneous highlights
These are some noteworthy fixes and improvements in this release:
  * **Performance**. If a recording fails, you now have the option to **Download raw trace events** and try to figure out what went wrong ([commit](https://chromium.googlesource.com/devtools/devtools-frontend/+/a0e0f7163bd234a548f870f194caaf15c0ba7d8f)).
  ...
  * **Developer Resources**. Fixed a bug that prevented reporting CSS resources and their issues ([1420362](https://crbug.com/1420362)).
  * **Elements** : 
    * Fixed a bug with inspecting elements in iframes ([1453375](https://crbug.com/1453375)).
    * **Computed**. Fixed a bug that prevented default values from rendering ([1499882](https://crbug.com/1499882)).
    * **Search**. Fixed a bug that prevented calculating the number of matches for short queries of one or two characters ([1416457](https://crbug.com/1416457)).
  * **Console**. Now correctly parses regular expressions that end with an escaped character in the **Filter** box ([1346936](https://crbug.com/1346936)).
  * **Settings** > **Workspace**. Fixed a bug that prevented adding an excluded folder ([1503580](https://crbug.com/1503580)).
  * **Network** > **Preview**. Now renders images with `data:` URIs ([1381791](https://crbug.com/1381791)).
  * **Memory**. Added proper upload load and download save buttons to the action bar ([1275407](https://crbug.com/1275407)).
