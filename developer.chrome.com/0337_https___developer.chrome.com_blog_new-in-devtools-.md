---
url: https://developer.chrome.com/blog/new-in-devtools-130?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-130?hl=en
date: 2025-05-11T16:58:11.142248
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#main-content)
  * [Español – América Latina](https://developer.chrome.com/blog/new-in-devtools-130?hl=es-419)




  * On this page
  * [Network panel improvements](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#network)
    * [Network filters reimagined](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#network-filters)
    * [HAR exports now exclude sensitive data by default](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#har)
  * [Elements panel improvements](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#elements)
    * [Autocomplete values for text-emphasis-* properties](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#autocomplete)
    * [Scroll overflows marked with a badge](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#scroll-badge)
    * [Bare declarations after nested rules don't "shift up"](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#css-nesting)
  * [Performance panel improvements](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#perf)
    * [Recommendations in live metrics](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#live-metrics-recommendations)
    * [Navigate breadcrumbs](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#breadcrumbs)
  * [Memory panel improvements](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#memory)
    * [New 'Detached elements' profile](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#detached-elements)
    * [Improved naming of plain JS objects](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#object-names)
  * [Turn off dynamic theming](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#dynamic-theming)
  * [Chrome Experiment: Process sharing](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#process-sharing)
  * [Lighthouse 12.2.1](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#lighthouse)
  * [Miscellaneous highlights](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#misc)
  * [Download the preview channels](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#preview-channels)
  * [Get in touch with the Chrome DevTools team](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#contact-us)
  * [What's new in DevTools](https://developer.chrome.com/blog/new-in-devtools-130?hl=en#whats-new)
...
To bring back the old filter design, clear settings **Settings** > **Experiments** > check_box_outline_blank **Redesign of the filter bar in the Network panel**.
[Let us know what you think](https://issues.chromium.org/issues/40940823) about the reimagined design.
Chromium issue: [362672528](https://crbug.com/362672528).
...
To export logs in HAR format _with_ the sensitive data, turn on settings **Settings** > **Preferences** > **Network** > check_box **Allow to generate HAR with sensitive data**. The **Network** panel will mark the download **Export** button with an arrow. Long-click the button and select **Export HAR (with sensitive data)** from the drop-down menu.
Chromium issue: [361717594](https://crbug.com/361717594).
...
Autocomplete in the **Styles** tab now suggests values for the following CSS properties:
  * [`text-emphasis`](https://developer.mozilla.org/docs/Web/CSS/text-emphasis) shorthand
  * [`text-emphasis-position`](https://developer.mozilla.org/docs/Web/CSS/text-emphasis-position)


Chromium issue: [361471205](https://crbug.com/361471205).
...
Chromium issue: [40670442](https://crbug.com/40670442).
### Bare declarations after nested rules don't "shift up"
Following the CSS Working Group's [decision](https://github.com/w3c/csswg-drafts/issues/8738#issuecomment-1768977689) to [allow for bare declarations to come after nested rules](https://web.dev/blog/css-nesting-cssnesteddeclarations), the **Styles** tab now doesn't "shift up" these declarations during parsing.
...
Chromium issue: [358119261](https://crbug.com/358119261).
## Performance panel improvements
This version brings an number of improvements to the **Performance** panel.
### Recommendations in live metrics
[Live metrics](https://developer.chrome.com/docs/devtools/performance/overview#live-metrics) can now provide metric-specific recommendations that help you configure your development environment as close as possible to what your users experience.
...
You can now navigate [breadcrumbs](https://developer.chrome.com/docs/devtools/performance/reference#breadcrumbs) in the timeline of a performance recording: "jump" back and forth between breadcrumbs, overwrite a child breadcrumbs, and remove multiple childs. Previously, when you selected a parent breadcrumb, its children would disappear.
...
Chromium issue: [350519222](https://crbug.com/350519222).
...
Chromium issue: [328472696](https://crbug.com/328472696).
## Chrome Experiment: Process sharing
Normally, when you open multiple tabs from the same website (like [Google Docs](https://google.com/docs)), Chrome creates a separate renderer process for each. The [**Process sharing**](https://developer.chrome.com/blog/process-sharing-experiment) experiment changes this by allowing multiple tabs to share the same renderer process to improve performance.
...
Process sharing can affect breakpoint debugging and performance analysis. For more information, see [Chrome Experiment: Process sharing](https://developer.chrome.com/blog/process-sharing-experiment).
## Lighthouse 12.2.1
The **Lighthouse** panel now runs Lighthouse 12.2.1.
This update introduces a `< 20 KB` ignore threshold for resource compression suggestions to help you focus only on the meaningful file size savings. See the [full list of changes](https://github.com/GoogleChrome/lighthouse/releases/tag/v12.2.1).
...
These are some noteworthy fixes and improvements in this release:
  * **Elements** : 
    * Multiple fixes for editing nested CSS ([41486635](https://crbug.com/41486635), [361477264](https://crbug.com/361477264), [328263458](https://crbug.com/328263458), [41487826](https://crbug.com/41487826)).
    * Fixed defined but empty-value custom properties parsing as undefined ([365578428](https://crbug.com/365578428)).
  * **Console** : Fixed a non-escaped ampersand in multi-line strings in cURL commands ([352651673](https://crbug.com/352651673)).
  * **Memory** : Fixed the default selection on pages with service workers, main thread now selected ([40669896](https://crbug.com/40669896)).
  * **Security** : The URL scheme highlighting now correctly updates as the security stage of an origin changes ([359920086](https://crbug.com/359920086)).
