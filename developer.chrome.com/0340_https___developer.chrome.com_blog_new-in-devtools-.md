---
url: https://developer.chrome.com/blog/new-in-devtools-132?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-132?hl=en
date: 2025-05-11T16:58:22.603034
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#main-content)
  * [Español – América Latina](https://developer.chrome.com/blog/new-in-devtools-132?hl=es-419)




  * On this page
  * [Debug network requests, source files, and performance traces with Gemini](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#ai-assistance)
  * [AI chat history](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#chat-history)
  * [Manage extension storage in Application > Storage](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#extension-storage)
  * [Performance improvements](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#perf)
    * [Interaction phases in live metrics](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#interaction-phases)
    * [Render blocking information in the Summary tab](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#render-blocking)
    * [Support for scheduler.postTask events and their initiator arrows](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#initiators)
  * [Animations panel and Elements > Styles tab improvements](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#animations)
    * [Jump from Elements > Styles to Animations](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#animations-link)
    * [Real-time updates in Computed tab](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#computed)
  * [Compute pressure emulation in Sensors](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#compute-pressure)
  * [JS objects with the same name grouped by source in the Memory panel](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#memory)
  * [A new look for settings](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#settings)
  * [Performance insights panel is deprecated and removed from DevTools](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#perf-insights)
  * [Miscellaneous highlights](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#misc)
  * [Download the preview channels](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#preview-channels)
  * [Get in touch with the Chrome DevTools team](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#contact-us)
  * [What's new in DevTools](https://developer.chrome.com/blog/new-in-devtools-132?hl=en#whats-new)
...
In addition to [CSS styling](https://developer.chrome.com/blog/new-in-devtools-131#ai-assistance), you can now chat with Gemini about network requests, source files, and performance traces.
...
The DevTools team is looking forward to hearing your feedback in [crbug.com/364805393](https://crbug.com/364805393).
## AI chat history
You can now restore and view past chats with Gemini in the **AI assistance** panel by clicking the add **New chat** button in the upper left corner of the panel or by using the **Ask AI** buttons and menu options of the **Network** panel, **Sources** > **Page** tab, and **Performance** > **Main** track.
To view one of your previous chats, select the corresponding prompt from the drop-down menu under the history **History** button. The **AI assistance** panel will remember your chat history while DevTools is open.
## Manage extension storage in Application > Storage
Similar to local and session storage, you can now [view and change extension storage entries](https://developer.chrome.com/docs/devtools/storage/extensionstorage) in the **Application** > **Storage** section.
Chromium issue: [crbug.com/40963428](https://crbug.com/40963428).
...
As communicated in [The Web Vitals extension, now in DevTools](https://developer.chrome.com/blog/web-vitals-extension), the release of these features marks the end of support for the Web Vitals extension.
Chromium issue: [crbug.com/369097528](https://crbug.com/369097528).
...
The **Performance** > **Main** track now shows [`scheduler.postTask()`](https://developer.mozilla.org/docs/Web/API/Scheduler/postTask) events and the following initiator arrows between:
  * `Schedule postTask` -> `Fire postTask`
  * `Schedule postTask` -> `Abort postTask`


Chromium issue: [crbug.com/40775984](https://crbug.com/40775984).
...
Chromium issue: [crbug.com/362277525](https://crbug.com/362277525).
...
Chromium issue: [crbug.com/357902505](https://crbug.com/357902505).
...
All the important and useful features from the **Performance insights** panel have now found a new home in the **Performance** panel, specifically in [live metrics](https://developer.chrome.com/docs/devtools/performance/overview#live-metrics), the [**Insights** sidebar tab](https://developer.chrome.com/blog/new-in-devtools-131/?utm_source=devtools#insights), and the [**Layout shifts** track](https://developer.chrome.com/blog/new-in-devtools-131#cls). So, this version deprecates and removes the **Performance insights** panel from DevTools.
The DevTools team is grateful for the [feedback you provided](https://crbug.com/339361574) on this panel's deprecation and the overall performance debugging experience. As always, we like hearing your thoughts and learning about your perspectives. Keep them coming!
## Miscellaneous highlights
These are some noteworthy fixes and improvements in this release:
  * **Performance** : 
    * Removed an unnecessary limit of 3 characters for search queries.
    * Added the home **Home** button that takes you back to live metrics screen.
    * Fixed the previously broken `Shift`+`S`/`W` trace zoom shortcuts.
  * **Elements** > **Styles** : 
    * Added [anchor-center](https://developer.mozilla.org/docs/Web/CSS/CSS_anchor_positioning/Using#centering_on_the_anchor_using_anchor-center) to autocomplete [341991541](https://crbug.com/341991541).
    * Fixed a bug with flexbox editor not available for 2-word values [341964645](https://crbug.com/341964645).
  * **Network** : Prefetch failures are now yellow warnings instead or red errors to designate that the content display isn't affected [372055494](https://crbug.com/372055494).
