---
url: https://developer.chrome.com/blog/new-in-devtools-124?hl=en
title: https://developer.chrome.com/blog/new-in-devtools-124?hl=en
date: 2025-05-11T16:57:49.120493
depth: 2
---

[ Skip to main content ](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#main-content)


  * On this page
  * [New Autofill panel](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#autofill)
  * [Enhanced network throttling for WebRTC](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#throttling)
  * [Scroll-driven animations support in the Animations panel](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#animations)
  * [Improved CSS nesting support in Elements > Styles](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#nested-css)
  * [Enhanced Performance panel](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#perf)
    * [Hide functions and their children in the flame chart](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#hide-func)
    * [Arrows from selected initiators to events they initiated](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#event-initiators)
  * [Lighthouse 11.6.0](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#lighthouse)
  * [Tooltips for special categories in Memory > Heap snapshots](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#heap)
  * [Application > Storage updates](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#storage)
    * [Bytes used for shared storage](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#shared-storage-bytes)
    * [Web SQL is fully deprecated](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#web-sql)
  * [Coverage panel improvements](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#coverage)
  * [The Layers panel might be deprecated](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#layers)
  * [JavaScript Profiler deprecation: Phase four, final](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#js-profiler)
  * [Miscellaneous highlights](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#misc)
  * [Download the preview channels](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#preview-channels)
  * [Get in touch with the Chrome DevTools team](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#contact-us)
  * [What's new in DevTools](https://developer.chrome.com/blog/new-in-devtools-124?hl=en#whats-new)
...
## New Autofill panel
This version brings the new **Autofill** panel to DevTools. [Chrome Autofill](https://web.dev/learn/forms/autofill) provides a convenient way to automatically fill forms on websites with saved addresses. The new **Autofill** panel lets you inspect the mapping between your form fields, predicted autofill values, and saved data.
Try the new panel on this [demo page](https://rsolomakhin.github.io/autofill/) with test data:
...
To learn more, see [Learn Forms](https://web.dev/learn/forms) and [Autofill](https://web.dev/learn/forms/autofill).
## Enhanced network throttling for WebRTC
With the fresh addition of packet-related parameters to custom network throttling profiles, you can now throttle your [WebRTC](https://webrtc.org/) applications right in DevTools. This is useful to test your real-time communication implementation, without the need to use third-party software.
...
Try the new parameters on this [demo page](https://webrtc.github.io/samples/src/content/peerconnection/pc1/). First, allow the page to use the camera. Then, in the **Network** panel, select the custom profile you configured, and, back on the page, click **Start** and **Call**.
Chromium issue: [41175925](https://crbug.com/41175925).
## Scroll-driven animations support in the Animations panel
The **Animations** panel now lets you inspect [scroll-driven animations](https://developer.chrome.com/docs/css-ui/scroll-driven-animations).
Try this feature on this [demo page](https://scroll-driven-animations.style/). Open the **Animations** panel and reload the page to capture scroll-driven animations.
[An animation group](https://developer.chrome.com/devtools/css/animations#whats_an_animation_group) marked with a mouse mouse icon appears in the **Overview**. You can now [inspect it](https://developer.chrome.com/docs/devtools/css/animations#inspect). The group shows pixel values instead of milliseconds in the **Timeline**.
## Improved CSS nesting support in Elements > Styles
The **Elements** > **Styles** tab improves CSS nesting support and now shows nested styles with indentation and in braces. [CSS nesting](https://developer.chrome.com/docs/css-ui/css-nesting) is a way to group CSS rules together and make things less verbose and more structured.
Chromium issue: [40166888](https://crbug.com/40166888).
...
Previously, when you selected and event in the **Main** track, the track showed an arrow from its [initiator to the selected event](https://developer.chrome.com/blog/new-in-devtools-122#event-initiators). Now, the track also shows an arrow from the selected event to the one it initiated, if any.
...
Chromium issues: [325604258](https://crbug.com/325604258), [325024819](https://crbug.com/325024819), [326055289](https://crbug.com/326055289).
## Lighthouse 11.6.0
The **Lighthouse** panel now runs Lighthouse 11.6.0. See the [full list of changes](https://github.com/GoogleChrome/lighthouse/releases/tag/v11.6.0).
...
Heap snapshots in the **Memory** panel have [special groups of objects](https://developer.chrome.com/docs/devtools/memory-problems/heap-snapshots?utm_source=devtools#constructors) that aren't based on constructors. When you hover over such objects, the **Memory** panel now shows you a tooltip with a short description and a link to a longer description in documentation.
Chromium issue: [41490331](https://crbug.com/41490331).
...
[Shared storage](https://developers.google.com/privacy-sandbox/relevance/shared-storage) lets you have unlimited, cross-site storage write access with privacy-preserving read access.
Chromium issue: [324464353](https://crbug.com/324464353).
### Web SQL is fully deprecated
[Chrome deprecated Web SQL](https://developer.chrome.com/blog/deprecating-web-sql) in version 119 and removed the deprecation trial token in this version, so you can no longer use Web SQL.
Following suit, DevTools removed the **Web SQL** section from the **Application** panel.
Chromium issue: [327254049](https://crbug.com/327254049).
...
Chromium issue: [41494198](https://crbug.com/41494198), [329253687](https://crbug.com/329253687).
...
Feel free to [share your thoughts and concerns](https://crbug.com/328948996) before the team makes the final decision to deprecate the panel.
...
To profile CPU performance, [use the **Performance** panel](https://developer.chrome.com/docs/devtools/performance/nodejs).
Chromium issue: [40262073](https://crbug.com/40262073).
## Miscellaneous highlights
These are some noteworthy fixes and improvements in this release:
  * **Network** : 
    * Fixed a bug with the incorrect parsing of multi-line cookies ([325410304](https://crbug.com/325410304)).
    * Fixed call stack preview in the **Initiator** column ([327665602](https://crbug.com/327665602)).
  * **Performance monitor** : Track checkboxes are now the same as in the rest of UI ([1467464](https://crbug.com/1467464)).
  * **Sources** : Added syntax highlighting for XHTML documents ([327940244](https://crbug.com/327940244)).
  * **Settings** > **Devices** : Old Galaxy Fold is replaced with newer Galaxy Z Fold 5 ([40113439](https://crbug.com/40113439)).
  * **Performance** : All matched search results are now highlighted when searching with `Ctrl`/`Cmd`+`F` ([1523279](https://crbug.com/1523279)).
  * **Developer resources** : Now also shows resources loaded through language extensions, such as [C/C++ DevTools Support (DWARF) Chrome extension](https://goo.gle/wasm-debugging-extension) ([40746829](https://crbug.com/40746829)).
  * **Performance** : Fixed cropped call stack and its bad layout in the **Summary** tab ([325314708](https://crbug.com/325314708)).
