---
url: https://reactnative.dev/docs/0.73/accessibilityinfo
title: https://reactnative.dev/docs/0.73/accessibilityinfo
date: 2025-05-10T21:37:05.523531
depth: 2
---

[Skip to main content](https://reactnative.dev/docs/0.73/accessibilityinfo#__docusaurus_skipToContent_fallback)
...
## Example[​](https://reactnative.dev/docs/0.73/accessibilityinfo#example "Direct link to Example")
# Reference
## Methods[​](https://reactnative.dev/docs/0.73/accessibilityinfo#methods "Direct link to Methods")
### `addEventListener()`[​](https://reactnative.dev/docs/0.73/accessibilityinfo#addeventlistener "Direct link to addeventlistener")
tsx
```
...
### `announceForAccessibility()`[​](https://reactnative.dev/docs/0.73/accessibilityinfo#announceforaccessibility "Direct link to announceforaccessibility")
tsx
```
...
### `announceForAccessibilityWithOptions()`[​](https://reactnative.dev/docs/0.73/accessibilityinfo#announceforaccessibilitywithoptions "Direct link to announceforaccessibilitywithoptions")
tsx
```
...
Android
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#getrecommendedtimeoutmillis-android "Direct link to getrecommendedtimeoutmillis-android")
tsx
```
...
Android
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isaccessibilityserviceenabled-android "Direct link to isaccessibilityserviceenabled-android")
tsx
```
staticisAccessibilityServiceEnabled():Promise<boolean>;
```

Check whether any accessibility service is enabled. This includes TalkBack but also any third-party accessibility app that may be installed. To only check whether TalkBack is enabled, use [isScreenReaderEnabled](https://reactnative.dev/docs/0.73/accessibilityinfo#isscreenreaderenabled). Returns a promise which resolves to a boolean. The result is `true` when some accessibility services is enabled and `false` otherwise.
> **Note** : Please use [isScreenReaderEnabled](https://reactnative.dev/docs/0.73/accessibilityinfo#isscreenreaderenabled) if you only want to check the status of TalkBack.
### `isBoldTextEnabled()`
iOS
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isboldtextenabled-ios "Direct link to isboldtextenabled-ios")
tsx
```
...
### `isGrayscaleEnabled()`
iOS
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isgrayscaleenabled-ios "Direct link to isgrayscaleenabled-ios")
tsx
```
...
iOS
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isinvertcolorsenabled-ios "Direct link to isinvertcolorsenabled-ios")
tsx
```
...
### `isReduceMotionEnabled()`[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isreducemotionenabled "Direct link to isreducemotionenabled")
tsx
```
...
iOS
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isreducetransparencyenabled-ios "Direct link to isreducetransparencyenabled-ios")
tsx
```
...
### `isScreenReaderEnabled()`[​](https://reactnative.dev/docs/0.73/accessibilityinfo#isscreenreaderenabled "Direct link to isscreenreaderenabled")
tsx
```
...
iOS
[​](https://reactnative.dev/docs/0.73/accessibilityinfo#preferscrossfadetransitions-ios "Direct link to preferscrossfadetransitions-ios")
tsx
```
...
### `setAccessibilityFocus()`[​](https://reactnative.dev/docs/0.73/accessibilityinfo#setaccessibilityfocus "Direct link to setaccessibilityfocus")
tsx
```
...
Is this page useful?
  * [Methods](https://reactnative.dev/docs/0.73/accessibilityinfo#methods)
    * [`addEventListener()`](https://reactnative.dev/docs/0.73/accessibilityinfo#addeventlistener)
    * [`announceForAccessibility()`](https://reactnative.dev/docs/0.73/accessibilityinfo#announceforaccessibility)
    * [`announceForAccessibilityWithOptions()`](https://reactnative.dev/docs/0.73/accessibilityinfo#announceforaccessibilitywithoptions)
    * [`getRecommendedTimeoutMillis()` Android](https://reactnative.dev/docs/0.73/accessibilityinfo#getrecommendedtimeoutmillis-android)
    * [`isAccessibilityServiceEnabled()` Android](https://reactnative.dev/docs/0.73/accessibilityinfo#isaccessibilityserviceenabled-android)
    * [`isBoldTextEnabled()` iOS](https://reactnative.dev/docs/0.73/accessibilityinfo#isboldtextenabled-ios)
    * [`isGrayscaleEnabled()` iOS](https://reactnative.dev/docs/0.73/accessibilityinfo#isgrayscaleenabled-ios)
    * [`isInvertColorsEnabled()` iOS](https://reactnative.dev/docs/0.73/accessibilityinfo#isinvertcolorsenabled-ios)
    * [`isReduceMotionEnabled()`](https://reactnative.dev/docs/0.73/accessibilityinfo#isreducemotionenabled)
    * [`isReduceTransparencyEnabled()` iOS](https://reactnative.dev/docs/0.73/accessibilityinfo#isreducetransparencyenabled-ios)
    * [`isScreenReaderEnabled()`](https://reactnative.dev/docs/0.73/accessibilityinfo#isscreenreaderenabled)
    * [`prefersCrossFadeTransitions()` iOS](https://reactnative.dev/docs/0.73/accessibilityinfo#preferscrossfadetransitions-ios)
    * [`setAccessibilityFocus()`](https://reactnative.dev/docs/0.73/accessibilityinfo#setaccessibilityfocus)
