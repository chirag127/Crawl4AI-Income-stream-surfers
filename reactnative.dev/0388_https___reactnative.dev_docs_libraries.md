---
url: https://reactnative.dev/docs/libraries
title: https://reactnative.dev/docs/libraries
date: 2025-05-10T21:40:37.084501
depth: 2
---

[Skip to main content](https://reactnative.dev/docs/libraries#__docusaurus_skipToContent_fallback)
...
## Selecting a Package Manager[​](https://reactnative.dev/docs/libraries#selecting-a-package-manager "Direct link to Selecting a Package Manager")
...
## Installing a Library[​](https://reactnative.dev/docs/libraries#installing-a-library "Direct link to Installing a Library")
...
shell
```
yarnadd react-native-webview
```

The library that we installed includes native code, and we need to link to our app before we use it.
## Linking Native Code on iOS[​](https://reactnative.dev/docs/libraries#linking-native-code-on-ios "Direct link to Linking Native Code on iOS")
...
## Linking Native Code on Android[​](https://reactnative.dev/docs/libraries#linking-native-code-on-android "Direct link to Linking Native Code on Android")
...
## Finding Libraries[​](https://reactnative.dev/docs/libraries#finding-libraries "Direct link to Finding Libraries")
...
## Determining Library Compatibility[​](https://reactnative.dev/docs/libraries#determining-library-compatibility "Direct link to Determining Library Compatibility")
### Does it work with React Native?[​](https://reactnative.dev/docs/libraries#does-it-work-with-react-native "Direct link to Does it work with React Native?")
...
### Does it work for the platforms that my app supports?[​](https://reactnative.dev/docs/libraries#does-it-work-for-the-platforms-that-my-app-supports "Direct link to Does it work for the platforms that my app supports?")
...
### Does it work with my app version of React Native?[​](https://reactnative.dev/docs/libraries#does-it-work-with-my-app-version-of-react-native "Direct link to Does it work with my app version of React Native?")
...
Is this page useful?
  * [Selecting a Package Manager](https://reactnative.dev/docs/libraries#selecting-a-package-manager)
  * [Installing a Library](https://reactnative.dev/docs/libraries#installing-a-library)
  * [Linking Native Code on iOS](https://reactnative.dev/docs/libraries#linking-native-code-on-ios)
  * [Linking Native Code on Android](https://reactnative.dev/docs/libraries#linking-native-code-on-android)
  * [Finding Libraries](https://reactnative.dev/docs/libraries#finding-libraries)
  * [Determining Library Compatibility](https://reactnative.dev/docs/libraries#determining-library-compatibility)
    * [Does it work with React Native?](https://reactnative.dev/docs/libraries#does-it-work-with-react-native)
    * [Does it work for the platforms that my app supports?](https://reactnative.dev/docs/libraries#does-it-work-for-the-platforms-that-my-app-supports)
    * [Does it work with my app version of React Native?](https://reactnative.dev/docs/libraries#does-it-work-with-my-app-version-of-react-native)
