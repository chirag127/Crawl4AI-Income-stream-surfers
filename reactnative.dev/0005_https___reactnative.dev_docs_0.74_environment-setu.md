---
url: https://reactnative.dev/docs/0.74/environment-setup
title: https://reactnative.dev/docs/0.74/environment-setup
date: 2025-05-10T21:28:50.528693
depth: 1
---

[Skip to main content](https://reactnative.dev/docs/0.74/environment-setup#__docusaurus_skipToContent_fallback)
...
If your app has unusual constraints that are not served well by a Framework, or you prefer to solve these problems yourself, you can make a React Native app without a Framework using Android Studio, Xcode. If you’re interested in this path, learn how to [set up your environment](https://reactnative.dev/docs/0.74/set-up-your-environment) and how to [get started without a framework](https://reactnative.dev/docs/0.74/getting-started-without-a-framework).
## Start a new React Native project with Expo[​](https://reactnative.dev/docs/0.74/environment-setup#start-a-new-react-native-project-with-expo "Direct link to Start a new React Native project with Expo")
**Platform support**
Android
iOS
TV
