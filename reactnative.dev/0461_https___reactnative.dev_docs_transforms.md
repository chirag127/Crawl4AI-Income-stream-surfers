---
url: https://reactnative.dev/docs/transforms
title: https://reactnative.dev/docs/transforms
date: 2025-05-10T21:42:42.927694
depth: 2
---

[Skip to main content](https://reactnative.dev/docs/transforms#__docusaurus_skipToContent_fallback)
Join us for React Conf on Oct 7-8. [Learn more](https://conf.react.dev).
On this page
Transforms are style properties that will help you modify the appearance and position of your components using 2D or 3D transformations. However, once you apply transforms, the layouts remain the same around the transformed component hence it might overlap with the nearby components. You can apply margin to the transformed component, the nearby components or padding to the container to prevent such overlaps.
## Example[​](https://reactnative.dev/docs/transforms#example "Direct link to Example")
# Reference
## Transform[​](https://reactnative.dev/docs/transforms#transform "Direct link to Transform")
...
### `decomposedMatrix`, `rotation`, `scaleX`, `scaleY`, `transformMatrix`, `translateX`, `translateY`[​](https://reactnative.dev/docs/transforms#decomposedmatrix-rotation-scalex-scaley-transformmatrix-translatex-translatey "Direct link to decomposedmatrix-rotation-scalex-scaley-transformmatrix-translatex-translatey")
> **Deprecated.** Use the [`transform`](https://reactnative.dev/docs/transforms#transform) prop instead.
## Transform Origin[​](https://reactnative.dev/docs/transforms#transform-origin "Direct link to Transform Origin")
...
# Example
### Values[​](https://reactnative.dev/docs/transforms#values "Direct link to Values")
...
#### One-value syntax:[​](https://reactnative.dev/docs/transforms#one-value-syntax "Direct link to One-value syntax:")
...
#### Two-value syntax:[​](https://reactnative.dev/docs/transforms#two-value-syntax "Direct link to Two-value syntax:")
...
#### Three-value syntax:[​](https://reactnative.dev/docs/transforms#three-value-syntax "Direct link to Three-value syntax:")
...
#### Array syntax[​](https://reactnative.dev/docs/transforms#array-syntax "Direct link to Array syntax")
...
js
```
// Using numeric valuestransformOrigin:[10,30,40],// Mixing numeric and percentage valuestransformOrigin:[10,'20%',0],
```
...
Is this page useful?
  * [Transform](https://reactnative.dev/docs/transforms#transform)
    * [`decomposedMatrix`, `rotation`, `scaleX`, `scaleY`, `transformMatrix`, `translateX`, `translateY`](https://reactnative.dev/docs/transforms#decomposedmatrix-rotation-scalex-scaley-transformmatrix-translatex-translatey)
  * [Transform Origin](https://reactnative.dev/docs/transforms#transform-origin)
