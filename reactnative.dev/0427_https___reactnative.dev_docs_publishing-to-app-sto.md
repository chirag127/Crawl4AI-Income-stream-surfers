...
title: https://reactnative.dev/docs/publishing-to-app-store
date: 2025-05-10T21:41:45.273342
depth: 2
---

[Skip to main content](https://reactnative.dev/docs/publishing-to-app-store#__docusaurus_skipToContent_fallback)
...
### 1. Configure release scheme[​](https://reactnative.dev/docs/publishing-to-app-store#1-configure-release-scheme "Direct link to 1. Configure release scheme")
...
#### Pro Tips[​](https://reactnative.dev/docs/publishing-to-app-store#pro-tips "Direct link to Pro Tips")
...
shell
```
if["${CONFIGURATION}"=="Debug"];thenexportSKIP_BUNDLING=truefi
```

### 2. Build app for release[​](https://reactnative.dev/docs/publishing-to-app-store#2-build-app-for-release "Direct link to 2. Build app for release")
...
### 4. Screenshots[​](https://reactnative.dev/docs/publishing-to-app-store#4-screenshots "Direct link to 4. Screenshots")
...
Is this page useful?
  * [1. Configure release scheme](https://reactnative.dev/docs/publishing-to-app-store#1-configure-release-scheme)
  * [2. Build app for release](https://reactnative.dev/docs/publishing-to-app-store#2-build-app-for-release)
  * [4. Screenshots](https://reactnative.dev/docs/publishing-to-app-store#4-screenshots)
