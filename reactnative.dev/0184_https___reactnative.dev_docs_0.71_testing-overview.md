---
url: https://reactnative.dev/docs/0.71/testing-overview
title: https://reactnative.dev/docs/0.71/testing-overview
date: 2025-05-10T21:36:41.665105
depth: 2
---

[Skip to main content](https://reactnative.dev/docs/0.71/testing-overview#__docusaurus_skipToContent_fallback)
...
## Why Test[​](https://reactnative.dev/docs/0.71/testing-overview#why-test "Direct link to Why Test")
...
## Static Analysis[​](https://reactnative.dev/docs/0.71/testing-overview#static-analysis "Direct link to Static Analysis")
...
React Native comes with two such tools configured out of the box: [ESLint](https://eslint.org/) for linting and [TypeScript](https://reactnative.dev/docs/0.71/typescript) for type checking.
## Writing Testable Code[​](https://reactnative.dev/docs/0.71/testing-overview#writing-testable-code "Direct link to Writing Testable Code")
...
## Writing Tests[​](https://reactnative.dev/docs/0.71/testing-overview#writing-tests "Direct link to Writing Tests")
After writing testable code, it’s time to write some actual tests! The default template of React Native ships with [Jest](https://jestjs.io) testing framework. It includes a preset that's tailored to this environment so you can get productive without tweaking the configuration and mocks straight away—[more on mocks](https://reactnative.dev/docs/0.71/testing-overview#mocking) shortly. You can use Jest to write all types of tests featured in this guide.
> If you do test-driven development, you actually write tests first! That way, testability of your code is given.
### Structuring Tests[​](https://reactnative.dev/docs/0.71/testing-overview#structuring-tests "Direct link to Structuring Tests")
...
## Unit Tests[​](https://reactnative.dev/docs/0.71/testing-overview#unit-tests "Direct link to Unit Tests")
...
### Mocking[​](https://reactnative.dev/docs/0.71/testing-overview#mocking "Direct link to Mocking")
...
## Integration Tests[​](https://reactnative.dev/docs/0.71/testing-overview#integration-tests "Direct link to Integration Tests")
...
## Component Tests[​](https://reactnative.dev/docs/0.71/testing-overview#component-tests "Direct link to Component Tests")
...
### Testing User Interactions[​](https://reactnative.dev/docs/0.71/testing-overview#testing-user-interactions "Direct link to Testing User Interactions")
...
### Testing Rendered Output[​](https://reactnative.dev/docs/0.71/testing-overview#testing-rendered-output "Direct link to Testing Rendered Output")
...
## End-to-End Tests[​](https://reactnative.dev/docs/0.71/testing-overview#end-to-end-tests "Direct link to End-to-End Tests")
...
## Summary[​](https://reactnative.dev/docs/0.71/testing-overview#summary "Direct link to Summary")
...
### Links[​](https://reactnative.dev/docs/0.71/testing-overview#links "Direct link to Links")
...
Is this page useful?
  * [Static Analysis](https://reactnative.dev/docs/0.71/testing-overview#static-analysis)
  * [Writing Testable Code](https://reactnative.dev/docs/0.71/testing-overview#writing-testable-code)
  * [Writing Tests](https://reactnative.dev/docs/0.71/testing-overview#writing-tests)
    * [Structuring Tests](https://reactnative.dev/docs/0.71/testing-overview#structuring-tests)
  * [Unit Tests](https://reactnative.dev/docs/0.71/testing-overview#unit-tests)
  * [Integration Tests](https://reactnative.dev/docs/0.71/testing-overview#integration-tests)
  * [Component Tests](https://reactnative.dev/docs/0.71/testing-overview#component-tests)
    * [Testing User Interactions](https://reactnative.dev/docs/0.71/testing-overview#testing-user-interactions)
    * [Testing Rendered Output](https://reactnative.dev/docs/0.71/testing-overview#testing-rendered-output)
  * [End-to-End Tests](https://reactnative.dev/docs/0.71/testing-overview#end-to-end-tests)
  * [Summary](https://reactnative.dev/docs/0.71/testing-overview#summary)
