...
orientation| `DeviceMotionOrientation[](https://docs.expo.dev/versions/latest/sdk/devicemotion/#devicemotionorientation)`| Device orientation based on screen rotation. Value is one of:
  * `0` (portrait),
  * `90` (right landscape),
  * `180` (upside down),
  * `-90` (left landscape).
