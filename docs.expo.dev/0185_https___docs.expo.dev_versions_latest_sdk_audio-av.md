...
Property| Type| Description  
---|---|---  
audioQuality| `number`| The desired audio quality. See the [`IOSAudioQuality`](https://docs.expo.dev/versions/latest/sdk/audio-av/#iosaudioquality) enum for all valid values.  
